...
_G.packer_plugins = {
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["tabnine-nvim"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/tabnine-nvim",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
